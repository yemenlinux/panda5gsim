...
class SimManager(ShowBase):
    ...
    def loadTerrain(self, street_map=None):
        ...
        self.skydome1 = loader.loadModel(skydome_model)    # type: ignore  
        self.skydome1.reparentTo(render) # type: ignore
        self.skydome1.setPos(0,0,0)
        self.skydome1.setScale(skydome_scale) #8
        # 
        self.skydome2 = loader.loadModel(skydome_model) # type: ignore
        self.skydome2.reparentTo(render) # type: ignore
